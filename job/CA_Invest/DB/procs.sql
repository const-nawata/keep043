...
--	------------------------------------------------------------------------------------------------
--	------------------------------------------------------------------------------------------------
IF( `p_debug` AND `v_cur_date` = '2010-08-15' )THEN
	SET @get_busy_items_dbg	= CONCAT(
'INSERT INTO `tst_tbl` ( `d_t_start`, `d_t_end`, `info` )',
'( SELECT `d_t_start`, `d_t_end`, ', @ag_id, ' FROM ', `v_busy_items_tbl_name`, ')'
	);
	PREPARE get_busy_items_stmt_dbg FROM @get_busy_items_dbg;
	EXECUTE get_busy_items_stmt_dbg;



	SET @get_busy_items_dbg	= CONCAT(
'INSERT INTO `tst_tbl` ( `d_t_start`, `d_t_end`, `info` )',
'VALUES( \' ', `v_ag_d_t_start`, '\', \'2010-08-12 ', `v_ag_end_time`, '\', \'Fictive record\')'
	);
	PREPARE get_busy_items_stmt_dbg1 FROM @get_busy_items_dbg;
	EXECUTE get_busy_items_stmt_dbg1;
...
--	DEBUG ZONE (end)
					...
					SET @del_busy_items2	= 
					CONCAT(
'DELETE FROM ', `v_busy_items_tbl_name`, ' WHERE `d_t_end` <= \'', `v_ag_d_t_start`, '\' OR `d_t_start` = `d_t_end`' );
					...
					IF( `v_ag_start_time` = `v_ag_end_time` )THEN
						...
						SET @ins_ttl	= CONCAT( 'INSERT INTO ', `v_busy_items_tbl_name`, 
													...
													'( \'00:00:00 ', `v_cur_date`, '\', \'', `v_ag_d_t_start`, '\' ), ',
													'( \'', `v_max_d_t`, '\', \'', `v_max_d_t`, '\' )'
													);
...
--	Backed up block #1 place.
	...
	WHERE 
		...
		( ( UNIX_TIMESTAMP( `fr_d_t_end` ) - UNIX_TIMESTAMP( `fr_d_t_start` ) ) / 60 ) >= ', `v_app_type_dur`, ' LIMIT 1' );
...
-- 					IF `v_ag_start_time` < `v_ag_end_time` THEN
-- 						SET @ins_ttl	= CONCAT(
-- 'INSERT INTO ', `v_busy_items_tbl_name`, 
-- 	'( `d_t_start`, `d_t_end`  )',
-- 'VALUES',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', '00:00:00' ), '\', \'', CONCAT( `v_prv_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_cur_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_cur_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_nxt_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_nxt_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_anx_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_anx_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_anx_date`, ' ', '00:00:00' ), '\' )' );
-- 
-- 					ELSEIF `v_ag_start_time` > `v_ag_end_time` THEN
-- 						SET @ins_ttl	= CONCAT(
-- 'INSERT INTO ', `v_busy_items_tbl_name`,
...
-- 'VALUES',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', '00:00:00' ), '\', \'', CONCAT( `v_prv_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_cur_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_cur_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_nxt_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_nxt_date`, ' ', `v_ag_start_time` ), '\' ), ',
-- 	'( \'', CONCAT( `v_anx_date`, ' ', `v_ag_end_time` ), '\', \'', CONCAT( `v_anx_date`, ' ', '00:00:00' ), '\' )' 
-- );
-- 					ELSE
-- 						SET `v_max_d_t`	= CONCAT( `v_anx_date`, ' ', `v_ag_end_time` );
...
-- 	'( `d_t_start`, `d_t_end`  )',
-- 'VALUES',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', '00:00:00' ), '\', \'', CONCAT( `v_prv_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_cur_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_cur_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_nxt_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_nxt_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_anx_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_anx_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_anx_date`, ' ', '00:00:00' ), '\' )' );
-- 					ELSEIF `v_app_type_start` > `v_app_type_end` THEN
-- 						SET @ins_ttl	= CONCAT(
-- 'INSERT INTO ', `v_busy_items_tbl_name`,
-- 	'( `d_t_start`, `d_t_end`  )',
-- 'VALUES',
-- 	'( \'', CONCAT( `v_prv_date`, ' ', '00:00:00' ), '\', \'', CONCAT( `v_prv_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_cur_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_cur_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_nxt_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_nxt_date`, ' ', `v_app_type_start` ), '\' ), ',
-- 	'( \'', CONCAT( `v_anx_date`, ' ', `v_app_type_end` ), '\', \'', CONCAT( `v_anx_date`, ' ', '00:00:00' ), '\' )' 
-- );
-- 					END IF;
-- 
-- 					PREPARE ins_ttl_stmt1 FROM @ins_ttl;
-- 					EXECUTE ins_ttl_stmt1;
